...
public class Diffie_Hellman {
    public static void main(String[] args) {
        ...
        BigInteger alpha = BigInteger.valueOf(findPrimitive(q.intValue()));
        System.out.println("Primitive root of "+q+" is "+alpha);
        System.out.println("Enter value of Xa such that it is less than " + q);
        BigInteger Xa = new BigInteger(sc.next());
        BigInteger Ya = alpha.modPow(Xa, q);
        System.out.println("Ya is " + Ya);
        System.out.println("Enter value of Xb such that it is less than " + q);
        ...
        System.out.println("Ka is "+Ka+" and Kb is "+Kb);
        sc.close();
    }
